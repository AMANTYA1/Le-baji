...
def search_markup(
    ...
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton(
                text="Close ✖️", callback_data=f"forceclose {query}|{user_id}"
            )
        ],
    ]
    return buttons
...
def secondary_markup(videoid, user_id):
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="⚙️ More Menu", callback_data=f"other {videoid}|{user_id}"
            ),
...
def primary_markup(videoid, user_id, current_time, total_time):
    ...
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="⚙️ Menu", callback_data=f"other {videoid}|{user_id}"
            ),
            InlineKeyboardButton(text="Close ✖️", callback_data=f"close"),
        ],
    ]
