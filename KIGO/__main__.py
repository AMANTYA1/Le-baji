from KIGO.Plugins.custom.start import start_menu_private
import asyncio
import importlib
import os
import re
...
from KIGO.Inline import private_panel
from KIGO.Plugins import ALL_MODULES
from KIGO.Utilities.inline import paginate_modules
...
async def initiate_bot():
    ...
    console.print(
        "[bold green]Congrats!! KIGOMusic Bot has started successfully!\n"
    )
    try:
    ...
    if STRING1 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_1.join_chat("OmFoXD")
            await ASS_CLI_1.join_chat("kigo_omfo")
        except:
            pass
    ...
    if STRING2 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_2.join_chat("OmFoXD")
            await ASS_CLI_2.join_chat("kigo_omfo")
        except:
            pass
    ...
    if STRING3 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_3.join_chat("kigo_omfo")
            await ASS_CLI_3.join_chat("OmFoXD")
        except:
            pass
    ...
    if STRING4 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_4.join_chat("kigo_omfo")
            await ASS_CLI_4.join_chat("OmFoXD")
        except:
            pass
    ...
    if STRING5 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_5.join_chat("OmFoXD")
            await ASS_CLI_5.join_chat("kigo_omfo")
        except:
            pass
    ...
    if LOG_SESSION != "None":
        try:
            ...
            return
        try:
            await LOG_CLIENT.join_chat("OmFoXD")
            await LOG_CLIENT.join_chat("kigo_omfo")
        except:
            pass
    console.print(f"└[red] KIGO Music Bot Boot Completed.")
    if STRING1 != "None":
